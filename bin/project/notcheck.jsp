...
%>
<form action="<%=request.getContextPath()%>/project/notice.jsp" method="post">
</div>
<%    
    String listSql = "SELECT * FROM notice where `¹øÈ£`='"+num+"'";
...
%>
    <table border="0" width="90%">
        <thead>
            <tr align="center">
                <th width="10%">Á¦¸ñ</th><td colspan="3" align="left">&nbsp<%=listResultSet.getString(2)%></td>
                <tr><th colspan="4"><hr width="100%"></hr></th></tr>
                </tr>
                <tr align="center">
                <th width="10%">ÀÛ¼ºÀÚ</th><td align="left">&nbsp<%=listResultSet.getString(3)%></td>
                <th width="20%" align="right">&nbsp&nbsp&nbsp&nbspÀÛ¼ºÀÏ</th><td align="left">&nbsp<%=listResultSet.getString(4)%></td>
                </tr>
                <tr><th colspan="4"><hr width="100%"></hr></th></tr>
                <tr align="center">
                <th width="10%">³»¿ë</th>
                <%
                listSql = "SELECT * FROM content where `¹øÈ£`='"+num+"'";
                listStatement = connection.prepareStatement(listSql);
                listResultSet = listStatement.executeQuery();
              	listResultSet.next();
                %>
                <td colspan="3" align="left">&nbsp<%=listResultSet.getString(2) %></td>
                </tr>
                <tr>
