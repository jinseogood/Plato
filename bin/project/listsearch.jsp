...
try {
    ...
    String totalSql="SELECT COUNT(*) FROM request WHERE "+option+"='"+search+"'";
...
<%    
    ...
    String listSql="SELECT * FROM request WHERE "+option+"='"+search+"' order by `번호` LIMIT ?,?";
...
%>
          <!--    <a href='listsearch.jsp?currentPage=</a>-->
<%
		}
      }
%>
...
%>
    ...
    <tr>
      <td colspan="3"><div id="footer">COPYRIGHT (C) 2016 &quot;Plato Academy Co.,Ltd&quot;. DESIGN BY <a href="#">Plato Academy Co.,Ltd</a></div></td>
  <td>
