...
%>
  ...
  <!--  <div>ÀüÃ¼ÇàÀÇ ¼ö : <%=totalRowCount%> </div>-->
   ...
   <option value="`°¡¸ÍÁ¡¹øÈ£`">°¡¸ÍÁ¡¹øÈ£</option>
...
<%    
    int pagePerRow = 15;
    String listSql = "SELECT * FROM request ORDER BY `¹øÈ£` LIMIT ?, ?";
...
%>
<tr><td><br/></td></tr>
<tr><td colspan="5" align="right"><input type="button" onclick="location.href='form.jsp?totalrow=<%=totalRowCount %>'" value="°Ô½Ã±ÛÀÔ·Â">
</td></tr>
